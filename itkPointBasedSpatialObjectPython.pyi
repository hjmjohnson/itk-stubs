...
class listitkPointBasedSpatialObject2_Pointer:
    thisown: Any = ...
    iterator: Any = ...
...
class listitkPointBasedSpatialObject3_Pointer:
    thisown: Any = ...
    iterator: Any = ...
    def __iter__(self) -> Any: ...
    __nonzero__: Any = ...
...
itkPointBasedSpatialObject2___New_orig__: Any
itkPointBasedSpatialObject2_cast: Any
...
itkPointBasedSpatialObject3___New_orig__: Any
itkPointBasedSpatialObject3_cast: Any
