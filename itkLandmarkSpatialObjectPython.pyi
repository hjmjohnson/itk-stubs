...
class listitkLandmarkSpatialObject2_Pointer:
    thisown: Any = ...
    iterator: Any = ...
...
class listitkLandmarkSpatialObject3_Pointer:
    thisown: Any = ...
    iterator: Any = ...
    def __iter__(self) -> Any: ...
    __nonzero__: Any = ...
...
itkLandmarkSpatialObject2___New_orig__: Any
itkLandmarkSpatialObject2_cast: Any
...
itkLandmarkSpatialObject3___New_orig__: Any
itkLandmarkSpatialObject3_cast: Any
